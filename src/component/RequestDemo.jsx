    ...
    <main  >
			<section className="demo-form-section ">
				<div className="demo-form-con">
                    ...
                    {formik.errors.companyName && formik.touched.companyName && <small className="err-message">{formik.errors.companyName}</small>}
                    ...
                    {formik.errors.studentCount && formik.touched.studentCount && <small className="err-message">{formik.errors.studentCount}</small>}
									</div>
							</div>
                    ...
                    {formik.errors.name && formik.touched.name && <small className="err-message">{formik.errors.name}</small>}
                    ...
                    {formik.errors.surName && formik.touched.surName && <small className="err-message">{formik.errors.surName}</small>}
                    ...
                    {formik.errors.email && formik.touched.email && <small className="err-message">{formik.errors.email}</small>}
                    ...
                    {formik.errors.phone && formik.touched.phone && <small className="err-message">{formik.errors.phone}</small>}
                  ...
                  {formik.errors.contactTime && <small className="err-message">{formik.errors.contactTime}</small>}
